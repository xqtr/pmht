...
dialog --title "Nintendo 64" --cancel-label "Back" --no-items --menu "Please choose a game:" $l1 $col $l2 ${OPTIONS} 2> $tmp/answer


if [ "$?" = "0" ]
then
	ch=$(cat $tmp/answer)
	$n64 --fullscreen $n64_roms/$ch
